            ...
            <div class="footermobile">
                ...
                <div class="dropdown">
                    ...
                    <ul id="dropdownListServices">
                        <li class="p-2"><a href="{{ url('about') }}"
                                class="text-decoration-none text-white">About Us</a>
                        </li>
                        ...
                        <li class="p-2"><a href="{{ url('advertise') }}"
                                ...
                                Us</a></li>
                        <li class="p-2"><a href="{{ url('media') }}"
                                class="text-decoration-none text-white">Media
                                Relations</a></li>
                    ...
                    <div class="row p-3 justify-content-between">
                        ...
                        <div class="col-12 col-md-3 ps-5">
                            <ul class="list-inline  text-white ml-5 ">
                                ...
                                <li class="list-inline-item"><a href="#"
                                        class="text-decoration-none text-white"><i class="fas fa-chevron-up"></i></a>
                                </li>
