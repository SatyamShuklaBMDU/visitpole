...
@section('content-area')
    <div class="col-sm-9 shadow">
        <div class="card">
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data" id="adhpform">
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="post_number"></input>
                            </div>
                            <br>
                            <div class="form-group">
                                <label>Short Description<span class="text-danger">*</span></label>
                                <textarea rows="10" class="form-control" name="contentshort"></textarea>
                            </div>
                            <br>
                            <div class="form-group">
