...
<div class="col-sm-9 shadow">
    <div class="card">
       <div class="card-body">
          <form action="" method="post" enctype="multipart/form-data" id="adlpform">
             <div class="row">
                <div class="col-sm-7">
                   ...
                   <div class="form-group">
                      ...
                      <textarea class="form-control" rows="8" name="contentshort" required></textarea>
                   </div>
                   <br>
                   <div class="form-group">
             ...
             <div class="text-center">
                <a href="{{url()->previous()}}" class="btn btn-dark text-white">Back</a></button>
