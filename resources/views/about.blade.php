                ...
                <p class="text_croll">
                    <marquee direction="left" height="50px" onmouseover="this.stop();" onmouseout="this.start();">
                        ...
                        <a href="health.php" class="text-decoration-none text-dark">
                            ...
                            <!-- 5 -->
                            <a href="business.php" class="text-decoration-none text-dark">
                                Permal | </a>
                            <!-- 6 -->
    ...
    <body>
        ...
        <body>
            <div class="container-fluid">
                <div class="row ">
                    <!-- start row -->
                    <div class="col-md-9 px-5 pt-3 manish">
            ...
            <footer class="mobilefooter">
                <div class="footermobile">
                    ...
                    <div class="dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdownButtonServices"
                        ...
                        <ul id="dropdownListServices">
                            ...
                            <li class="p-2"><a href="#" class="text-decoration-none text-white">Corporate
                                    Information</a></li>
                            <li class="p-2"><a href="#"
                                    class="text-decoration-none text-white">Compliance</a></li>
                    ...
                    <div class="dropdown">
                        ...
                        <small class="text-secondary bm mx-4">&copy; 2022 – All Right Reserved. Designed and Developed
                ...
                <div class="row justify-content-around footer">
                    <div class="col-8  col-md-4 pt-1">
                        ...
                        <div class="ps-4">
                            ...
                            <ul class="list-unstyled text-white">
                                ...
                                <li class="p-2"><i class="fas fa-envelope-open-text"></i> <small>
                                        info@digitalutilization.com</small></li>
                                <li class="p-2"><i class="fas fa-medkit"></i><small> contact@support.com</small>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-8   col-md-2 pt-5">
                        ...
                        <div>
                            ...
                            <ul class="list-unstyled text-white text-left">
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">About
                                        Us</a></li>
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">Contact
                                        Us</a></li>
                                <li class="p-2"><a href="#"
                                        class="text-decoration-none text-white">Advertise With Us</a></li>
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">Media
                                        Relations</a></li>
                                <li class="p-2"><a href="#"
                                        class="text-decoration-none text-white">Corporate Information</a></li>
                                <li class="p-2"><a href="#"
                                        class="text-decoration-none text-white">Compliance</a></li>
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">Apps &
                                        Products</a></li>
                        ...
                        <div>
                            ...
                            <ul class="list-unstyled text-white text-left">
                                ...
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">Closed
                                        Captioning Policy</a></li>
                                <li class="p-2"><a href="#"
                                        class="text-decoration-none text-white">Accessbility Statement</a></li>
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">Personal
                                        Information</a></li>
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">Data
                                        Tracking</a></li>
                                <li class="p-2"><a href="#" class="text-decoration-none text-white">Register
                                        New Account</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-8  col-md-2 pt-5">
                        ...
                        <div>
                            ...
                            <p class="text-white" id="footer_subscription_form">Subscribe our newsletter for latest
                                world news. Let's stay updated!</p>
                    ...
                    <footer style="background-color:black; ">
                        <div class="row p-3 justify-content-between">
                            <div class="col-12 col-md-6  footerl ps-5">
                                <small class="text-secondary bm">&copy; 2022 – All Right Reserved. Designed and
                                    Developed by <b class="text-white"><a href="https://digitalutilization.com/"
                                ...
                                <ul class="list-inline  text-white ml-5 ">
                                    <li class="list-inline-item"><a href="#"
                                            class="text-decoration-none text-white"><i
                                                class="fab fa-facebook-f"></i></a></li>
                                    <li class="list-inline-item"><a href="#"
                                            class="text-decoration-none text-white"><i class="fab fa-twitter"></i></a>
                                    </li>
                                    <li class="list-inline-item"><a href="#"
                                            class="text-decoration-none text-white"><i
                                                class="fab fa-instagram"></i></a></li>
                                    <li class="list-inline-item"><a href="#"
                                            class="text-decoration-none text-white"><i
                                                class="fab fa-linkedin-in"></i></a></li>
                                    <li class="list-inline-item"><a href="#"
                                            class="text-decoration-none text-white"><i class="fab fa-youtube"></i></a>
                                    </li>
